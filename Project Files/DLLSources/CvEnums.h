...
static_assert(COMMAND_PROMOTION == 0);
static_assert(COMMAND_UPGRADE == 1);
static_assert(COMMAND_AUTOMATE == 2);
static_assert(COMMAND_WAKE == 3);
static_assert(COMMAND_CANCEL == 4);
static_assert(COMMAND_CANCEL_ALL == 5);
static_assert(COMMAND_STOP_AUTOMATION == 6);
static_assert(COMMAND_DELETE == 7);
static_assert(COMMAND_GIFT == 8);
static_assert(COMMAND_LOAD == 9);
static_assert(COMMAND_LOAD_UNIT == 10);
static_assert(COMMAND_LOAD_CARGO == 11);
static_assert(COMMAND_LOAD_YIELD == 12);
static_assert(COMMAND_UNLOAD == 13);
static_assert(COMMAND_UNLOAD_ALL == 14);
static_assert(COMMAND_LEARN == 15);
static_assert(COMMAND_KING_TRANSPORT == 16);
static_assert(COMMAND_ESTABLISH_MISSION == 17);
static_assert(COMMAND_SPEAK_WITH_CHIEF == 18);
static_assert(COMMAND_YIELD_TRADE == 19);
static_assert(COMMAND_SAIL_TO_EUROPE == 20);
static_assert(COMMAND_CHOOSE_TRADE_ROUTES == 21);
static_assert(COMMAND_ASSIGN_TRADE_ROUTE == 22);
static_assert(COMMAND_PROMOTE == 23);
static_assert(COMMAND_PROFESSION == 24);
static_assert(COMMAND_CLEAR_SPECIALTY == 25);
static_assert(COMMAND_HOTKEY == 26);
...
static_assert(MAX_JIT_ARRAY_VALUE <= 0xFF);

...
#pragma warning( disable: 4345 ) // remove warning for debug builds
...
#   include <cstring>
#endif
// make variable sizes match those used in the precompiled header
//#include <stdint.h>
...
#if 0
#ifdef DEBUG
		// must be disabled in all builds because of mixed build DLL. For unknown reasons this won't work in debug mode

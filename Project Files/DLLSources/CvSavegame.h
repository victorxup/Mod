...
public:
	...
	CvSavegameWriter(CvSavegameWriter const& writer);
	...
	void Write(SavegameVariableTypes eType, Coordinates const& variable);
...
private:
	...
	void WriteTableString(char const* szString);
